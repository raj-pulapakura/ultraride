...
export type ProductFragmentFragment = { __typename?: 'ProductGraphql', id: string, name: string, description: string, price: number, category: string, imageUrl: string, brand: string, tags: Array<{ __typename?: 'TagGraphql', id: string, productId: string, text: string }> };
...
export type CreateProductMutation = { __typename?: 'Mutation', createProduct?: { __typename?: 'ProductGeneralResponse', product?: { __typename?: 'ProductGraphql', id: string, name: string, description: string, price: number, category: string, imageUrl: string, brand: string, tags: Array<{ __typename?: 'TagGraphql', id: string, productId: string, text: string }> } | null | undefined, error?: { __typename?: 'FieldError', field: string, message: string, ufm: string } | null | undefined } | null | undefined };
...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'AccountGeneralResponse', account?: { __typename?: 'AccountGraphql', id: string, firstName: string, lastName: string, email: string } | null | undefined, error?: { __typename?: 'FieldError', field: string, message: string, ufm: string } | null | undefined } };
...
export type RegisterMutation = { __typename?: 'Mutation', register?: { __typename?: 'AccountGeneralResponse', account?: { __typename?: 'AccountGraphql', id: string, firstName: string, lastName: string, email: string, role: string } | null | undefined, error?: { __typename?: 'FieldError', field: string, message: string, ufm: string } | null | undefined } | null | undefined };
...
export type UpdateProductMutation = { __typename?: 'Mutation', updateProduct: { __typename?: 'ProductGeneralResponse', error?: { __typename?: 'FieldError', field: string, message: string, ufm: string } | null | undefined, product?: { __typename?: 'ProductGraphql', createdAt: string, id: string, updatedAt: string, name: string, description: string, category: string, price: number, imageUrl: string, tags: Array<{ __typename?: 'TagGraphql', id: string, createdAt: string, updatedAt: string, productId: string, text: string }> } | null | undefined } };

export type AccountsQueryVariables = Exact<{ [key: string]: never; }>;


export type AccountsQuery = { __typename?: 'Query', accounts: Array<{ __typename?: 'AccountGraphql', id: string, createdAt: string, updatedAt: string, firstName: string, lastName: string, email: string, role: string }> };
...
export type MeQuery = { __typename?: 'Query', me?: { __typename?: 'AccountGeneralResponse', account?: { __typename?: 'AccountGraphql', id: string, firstName: string, lastName: string, email: string, createdAt: string } | null | undefined, error?: { __typename?: 'FieldError', field: string, message: string, ufm: string } | null | undefined } | null | undefined };
...
export type ProductQuery = { __typename?: 'Query', product?: { __typename?: 'ProductGraphql', id: string, name: string, description: string, price: number, category: string, imageUrl: string, brand: string, tags: Array<{ __typename?: 'TagGraphql', id: string, productId: string, text: string }> } | null | undefined };

export type ProductsQueryVariables = Exact<{ [key: string]: never; }>;


export type ProductsQuery = { __typename?: 'Query', products: Array<{ __typename?: 'ProductGraphql', id: string, name: string, description: string, price: number, category: string, imageUrl: string, brand: string, tags: Array<{ __typename?: 'TagGraphql', id: string, productId: string, text: string }> }> };
...
export const useAccountsQuery = <
    ...
    useQuery<AccountsQuery, TError, TData>(
      ...
      fetcher<AccountsQuery, AccountsQueryVariables>(client, AccountsDocument, variables, headers),
      options
    );
...
export const useAdminMeQuery = <
    ...
    useQuery<AdminMeQuery, TError, TData>(
      ...
      fetcher<AdminMeQuery, AdminMeQueryVariables>(client, AdminMeDocument, variables, headers),
      options
    );
